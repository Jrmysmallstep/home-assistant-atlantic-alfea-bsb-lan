...
La V1.3.1 utilise les paramètres natifs de dérogation du régulateur au lieu de modifier les programmations Confort / Eco.

**Limitation de sécurité de la V1.3.1 :** la création d'une dérogation depuis l'entité Climate Home Assistant est volontairement limitée au **rafraîchissement** et à une demande **plus froide**. Le comportement équivalent en chauffage n'a pas encore été validé sur le bus et n'est donc pas activé dans cette version.
